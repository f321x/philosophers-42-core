...
/*   Updated: 2023/12/11 12:43:06 by ***REMOVED***            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//
// This function allocates memory for an array of pthread_t
// objects to represent the threads
// and an array of pthread_mutex_t objects to represent the
// forks. It also initializes the mutexes.
//
// @param args The pointer to the t_philos struct containing
// the simulation arguments.
// @return true if the allocation and initialization is
...
// @return Returns true if the philosopher is
...
// This function initializes the array of philosopher data and
// allocates memory for it.
// It also calls the allocate_threads function to create the
// threads for each philosopher.
// Additionally, it initializes a mutex for printing purposes.
// @param args A pointer to the t_philos struct containing the
// simulation data.
...
//
// @param args The pointer to the t_philos struct containing the
// necessary arguments.
// @return Returns true if the philosophers were
// successfully spawned and monitored, false otherwise.
